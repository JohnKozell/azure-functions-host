...
namespace Microsoft.Azure.WebJobs.Script.Workers
{
    ...
    {
        public static async Task<InvocationRequest> ToRpcInvocationRequest(this ScriptInvocationContext context, bool excludeHttpTriggerMetadata, ILogger logger, Capabilities capabilities)
        {
